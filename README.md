# MiSnap SDK v5.12.0 for Android
...
| :------------------------------- | ------------------: |
| Document                         | 6.83                | 
| Document and Barcode             | 10.01               | 
| Document and Biometric           | 14.85               | 
| Document, Barcode, and Biometric | 18.02               | 
| Document, Biometric, and NFC     | 20.52               | 
| Document Classification          | 14.93               | 
<!-- SIZE_TABLE_END -->
...
* Integrators may see 16 KB page-size alignment warnings related to the libBarcodeScannerLib native library; barcode scanning remains supported on standard 4 KB page-size devices, and limited issues under 16 KB page size are planned to be addressed in a subsequent release.
