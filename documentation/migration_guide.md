# MiSnap SDK v5.6.2 Migration Guide

## Upgrading the MiSnap SDK from v5.6.1 to v5.6.2
Starting with MiSnap SDK v5.6.2, the `nfc`, `combined-nfc` or `nfc-reader` modules depend on JMRTD v0.7.42, which addresses security vulnerabilities by updating to Bouncy Castle 1.78.
