# MiSnap SDK v5.8.0 Science Integration Guide
...
```groovy
dependencies {
    implementation "com.miteksystems.misnap:voice-processor:5.8.0"
}
```
...
```groovy
dependencies {
    implementation "com.miteksystems.misnap:nfc-reader:5.8.0"
}
```
